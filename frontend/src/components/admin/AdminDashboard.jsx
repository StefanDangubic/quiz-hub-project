      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-lg shadow">
          ...
          <div className="p-6 space-y-4">
            ...
            {/* <button className="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition-colors w-full text-left">
              <div className="p-2 bg-green-100 rounded-lg">
            ...
            <button className="flex items-center p-4 bg-purple-50 rounded-lg hover:bg-purple-100 transition-colors w-full text-left">
              <div className="p-2 bg-purple-100 rounded-lg">
                ...
                {recentQuizzes.map((quiz) => (
                  <div key={quiz.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">{quiz.questions?.length || 0} questions</p>
